          ...
          <div className="flex flex-col justify-start items-start dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
            ...
            <div className="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
              ...
              <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                ...
                <div className=" ml-10 flex justify-between space-x-3 items-start w-full">
                <p className="text-base dark:text-white xl:text-lg leading-3">
                     {order?.Product?.Category?.categoryName}
                  </p>
                  <p className="text-base dark:text-white xl:text-lg leading-3">
                    Rs. {order?.Product?.price}
                  </p>
                  <p className="text-base dark:text-white xl:text-lg leading-3 text-gray-800">
                    Qty: {order?.quantity}{' '}
                  </p>
                  <p className="text-base dark:text-white xl:text-lg font-semibold leading-3 text-gray-800">
              ...
              <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row items-center md:items-start">
                <div className="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4 xl:mt-8">
                  <p className="w-48  font-semibold lg:w-full dark:text-gray-300 xl:w-48 text-center md:text-left text-sm leading-5 text-gray-600">
                    UserName : {order?.Order?.User?.username}
                  </p>
                  <p className="text-base dark:text-white  leading-4 text-center md:text-left text-gray-800">
                    Address : {order?.Order?.shippingAddress}
                  </p>
                  <p className="w-48 lg:w-full dark:text-gray-300 xl:w-48 text-center md:text-left text-sm leading-5 text-gray-600">
                    Phone :{order?.Order?.phoneNumber}
                  </p>
                </div>
              </div>
